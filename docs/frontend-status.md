...
ครบ 18 route การใช้งาน + หน้าเริ่มต้น 1 หน้า:
...
| ประกาศ | posts/official/, posts/general/ | ข่าวที่เผยแพร่แล้ว แยก Section และแบ่งหน้า |
...
| งาน | assignments/, assignments/detail/?id=... | ตัวกรอง, list/calendar, สถานะ, note |
...
- ทดสอบอัตโนมัติ 13 รายการ: สิทธิ์, private progress/upsert, moderation, pagination, error retry, Section/urgency, HTML/URL safety, calendar, form mode, page render, sidebar preference
...
- Dashboard รวมทุก Section ใช้เส้นตายที่ใกล้ที่สุด เพราะ SRS ยังไม่มีตารางลงทะเบียนรายวิชา/Section ของแต่ละคน
